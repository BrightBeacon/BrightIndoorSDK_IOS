...
ARMV7_IPHONE_OUTPUT=`find ${PREFIX}/platform/armv7/*geos.a`
...
ARMV7S_IPHONE_OUTPUT=`find ${PREFIX}/platform/armv7s/*geos.a`
...
IOS_ARM64_OUTPUT=`find ${PREFIX}/platform/arm64/*geos.a`
...
IOS_SIM_OUTPUT=`find ${PREFIX}/platform/sim/*geos.a`
...
IOS_SIM_OUTPUT=
 ...
 IOS_SIM64_OUTPUT=`find ${PREFIX}/platform/sim64/*geos.a`
